# Customer Discovery · 8AdmVG

Materiais, pesquisa e MVPs dos 5 grupos de Customer Discovery da turma de **Administração · 8º Semestre (VG)** — FACC/Unifacc · Prof. Renato Rosa · Cerrado Tech.

**Site:** https://renato0503.github.io/8AdmVG/
...
- App de coleta do shopping: [`coleta/`](coleta/) · Partes 1–3: `Parte 1/`, `Parte 2/`, `Parte 3/`
- Pesquisa: [`_pesquisa/INDICE-PESQUISA.md`](_pesquisa/INDICE-PESQUISA.md) — 70 artigos reais (OpenAlex), conferidos por `_pesquisa/selecao.py`
- Integrantes: editar [`grupos.md`](grupos.md) e rodar `py _gerador/gen.py`
